...
class Video4(Page):
    form_model = 'player'
    def is_displayed(self):
        return self.player.role == Constants.fourth_ROLE
    def vars_for_template(self):
        return diccionario(self)
...
class Video5(Page):
    form_model = 'player'
    def is_displayed(self):
        return self.player.role == Constants.fifth_ROLE
    def vars_for_template(self):
        return diccionario(self)
...
class Video6(Page):
    form_model = 'player'
    def is_displayed(self):
        return self.player.role == Constants.sixth_ROLE
    def vars_for_template(self):
        return diccionario(self)
...
class Video7(Page):
    form_model = 'player'
    def is_displayed(self):
        return self.player.role == Constants.seventh_ROLE
    def vars_for_template(self):
        return diccionario(self)


page_sequence = [Video1, Video2, Video3, Video4, Video5, Video6, Video7]
